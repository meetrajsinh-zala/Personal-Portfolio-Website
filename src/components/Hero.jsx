...
const Hero = () => {
  ...
  return (
    <div className="min-h-screen bg-[url('/Hero%20Section.png')] bg-cover bg-center px-4 sm:px-6 md:px-10 select-none">
      <Navbar />
      ...
      <div className="pt-16 flex flex-col justify-center items-center min-h-[calc(100vh-64px)]">
        <div className="w-full max-w-4xl flex flex-col gap-8 px-4 text-center">
          ...
          <ScrollFadePop delay={0.2}>
            <h1 className="font-JetBrains text-2xl sm:text-4xl md:text-5xl font-bold text-[#6D837B] leading-snug">
              Hi, I’m John Doe <br />
          ...
          <ScrollFadePop delay={0.3}>
            <p className="text-[#B2C8BB] font-Inter font-medium text-base sm:text-lg md:text-2xl leading-relaxed">
          ...
          <ScrollFadePop delay={0.4}>
            <div className="flex justify-center">
              <button
                ...
                className="text-[#B2C8BB] border border-[#B2C8BB] text-base sm:text-lg font-bold font-Inter px-6 py-2 rounded-xl transition-all duration-300 ease-in-out hover:shadow-[0_0_12px_rgb(109_131_123)] hover:scale-105"
              >
                View Resume
              </button>
            </div>
